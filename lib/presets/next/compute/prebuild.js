...
import runDefaultBuild from './default/prebuild/index';
import runNodeBuild from './node/prebuild/index';
import { validationSupportAndRetrieveFromVcConfig } from './default/prebuild/validation/support';
...
async function prebuild(buildContext) {
  ...
  const nodeHandlerFile = 'lib/presets/next/compute/node/handler/index';
