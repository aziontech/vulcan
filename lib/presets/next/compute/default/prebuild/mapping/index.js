...
import { validateFile, normalizePath } from '../../../utils/fs';
import { formatRoutePath, stripIndexRoute } from '../../../utils/routing';
import { fixFunctionContent } from '../edge/index';
import handlePrerenderedRoutes from '../prerendered/index';
import { validationSupportAndRetrieveFromVcConfig } from '../validation/support';

/**
 *
 * @param {object} vcConfig object with the content of .vc-config.json
 * @returns {boolean} true if validRuntime, validEntrypoint
 */
